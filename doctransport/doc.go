...
func (reqres *docRequestResponse) BindMultipart(v interface{}) error {
	err := func() error {
		reqres.Lock()
		defer reqres.Unlock()
		return reqres.appendSimpleSchemaParameters("formData", v)
	}()
	if err != nil {
		return err
	}
	return reqres.inner.BindMultipart(v)
}
